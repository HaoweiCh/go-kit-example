...
import (
	...
	addpb "go-kit-example/cmd/addsvc/pb"
	"go-kit-example/cmd/addsvc/pkg/addendpoint"
	"go-kit-example/cmd/addsvc/pkg/addservice"
	"go-kit-example/cmd/addsvc/pkg/addtransport"
	addthrift "go-kit-example/cmd/addsvc/thrift/gen-go/addsvc"
)
